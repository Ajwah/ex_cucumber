    ...
    test "Over different sentences with repetition" do
      ...
      expected = %{
        :params => %{
          ...
          string: %{
            " this" =>
              format_ending(" sentence", full_sentence1,
                incorporate: %{
                  id: [
                    "000000000000000",
                    "000000000000000",
            ...
            :int => %{
              " sentence" => %{
                " is" => %{
                  :params =>
                    Map.put(
                      format_ending(:color, full_sentence5,
                        incorporate: %{
                          id: ["000000000000000", "000000000000000", "000000000000000"]
                        }
                      ),
                      :next_key,
                      %{end: :color}
          ...
          " is" => %{
            :params => %{
              ...
              :int =>
                ...
                |> Map.merge(
                  format_ending(" sentence", full_sentence2,
                    incorporate: %{
                      id: [
                        "000000000000000",
                        "000000000000000",
